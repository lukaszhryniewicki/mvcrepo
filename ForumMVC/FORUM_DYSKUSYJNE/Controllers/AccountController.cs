...
namespace FORUM_DYSKUSYJNE.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public ActionResult ActivationAccount(string id)
		{
			...
			var userAccount = _unitOfWork.Users.Find(u => u.ActivationCode.ToString().Equals(id)).FirstOrDefault();
		...
		{
			var user = _unitOfWork.Users.GetUserByCode(id);
			if (user == null)
			{
		...
		public ActionResult ChangePassword(ChangePasswordViewModel model)
		{
			...
			var user = _unitOfWork.Users.GetUserByCode(model.Code);
